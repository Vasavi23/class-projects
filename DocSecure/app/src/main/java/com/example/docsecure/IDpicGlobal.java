...
public class IDpicGlobal extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_i_dpic_global);
        if (ActivityCompat.checkSelfPermission(IDpicGlobal.this, Manifest.permission.READ_EXTERNAL_STORAGE)== PackageManager.PERMISSION_DENIED || ActivityCompat.checkSelfPermission(IDpicGlobal.this, Manifest.permission.CAMERA)== PackageManager.PERMISSION_DENIED){
            ActivityCompat.requestPermissions(IDpicGlobal.this,new String[]{
        ...
        id=getIntent().getStringExtra("IDCardid");
        ...
        sp=getSharedPreferences("IDfront"+username+id,MODE_PRIVATE);
        if(sp!=null) {
        ...
        sp2=getSharedPreferences("IDback"+username+id,MODE_PRIVATE);
        if(sp2!=null) {
        ...
        img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    Intent full = new Intent(IDpicGlobal.this, FullScreenZoom.class);
                    imagezoom=bitmap;
                    full.putExtra("zoomid","idcardzoom");
                    startActivity(full);
                }
                catch (Exception e){
                    Toast.makeText(IDpicGlobal.this, ""+e, Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    File f=new File(IDpicGlobal.this.getExternalCacheDir(),"ThisIsImageTitleString"+ " - " + (Calendar.getInstance().getTime())+".jpeg");
        ...
        share1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Bitmap mBitmap = ((BitmapDrawable) mDrawable).getBitmap();
                try {
                    File f=new File(IDpicGlobal.this.getExternalCacheDir(),"ThisIsImageTitle"+ " - " + (Calendar.getInstance().getTime())+".jpeg");
                    FileOutputStream fout=new FileOutputStream(f);
                    mBitmap.compress(Bitmap.CompressFormat.JPEG,80,fout);
                    fout.flush();
                    fout.close();
