...
public class RCbook extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_r_cbook);
        if (ActivityCompat.checkSelfPermission(RCbook.this, Manifest.permission.READ_EXTERNAL_STORAGE)== PackageManager.PERMISSION_DENIED || ActivityCompat.checkSelfPermission(RCbook.this, Manifest.permission.CAMERA)== PackageManager.PERMISSION_DENIED){
            ActivityCompat.requestPermissions(RCbook.this,new String[]{
        ...
        username=getIntent().getStringExtra("RCbookid");
        ...
        front=findViewById(R.id.RCfrontu1);
        back=findViewById(R.id.RCbacku1);


        sp=getSharedPreferences("RCfront"+username,MODE_PRIVATE);
        if(sp!=null) {
        ...
        sp2=getSharedPreferences("RCback"+username,MODE_PRIVATE);
        if(sp2!=null) {
        ...
        img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    Intent full = new Intent(RCbook.this, FullScreenZoom.class);
                    imagezoom=bitmap;
                    full.putExtra("zoomid","rczoom");
                    startActivity(full);
                }
                catch (Exception e){
                    Toast.makeText(RCbook.this, ""+e, Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    File f=new File(RCbook.this.getExternalCacheDir(),"RCfront"+ " - " + (Calendar.getInstance().getTime())+".jpeg");
        ...
        share1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Bitmap mBitmap = ((BitmapDrawable) mDrawable).getBitmap();
                try {
                    File f=new File(RCbook.this.getExternalCacheDir(),"RCback"+ " - " + (Calendar.getInstance().getTime())+".jpeg");
                    FileOutputStream fout=new FileOutputStream(f);
                    mBitmap.compress(Bitmap.CompressFormat.JPEG,80,fout);
                    fout.flush();
                    fout.close();
