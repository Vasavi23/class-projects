...
public class Rationcard extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ActivityCompat.checkSelfPermission(Rationcard.this, Manifest.permission.READ_EXTERNAL_STORAGE)== PackageManager.PERMISSION_DENIED || ActivityCompat.checkSelfPermission(Rationcard.this, Manifest.permission.CAMERA)== PackageManager.PERMISSION_DENIED){
            ActivityCompat.requestPermissions(Rationcard.this,new String[]{
        ...
        username=getIntent().getStringExtra("rationcardid");
        ...
        front=findViewById(R.id.rationfrontu1);
        back=findViewById(R.id.rationbacku1);


        sp=getSharedPreferences("Rationcardfront"+username,MODE_PRIVATE);
        if(sp!=null) {
        ...
        sp2=getSharedPreferences("Rationcardback"+username,MODE_PRIVATE);
        if(sp2!=null) {
        ...
        img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    Intent full = new Intent(Rationcard.this, FullScreenZoom.class);
                    imagezoom=bitmap;
                    full.putExtra("zoomid","rationcardzoom");
                    startActivity(full);
                }
                catch (Exception e){
                    Toast.makeText(Rationcard.this, ""+e, Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    File f=new File(Rationcard.this.getExternalCacheDir(),"ThisIsImageTitleString"+ " - " + (Calendar.getInstance().getTime())+".jpeg");
        ...
        share1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Bitmap mBitmap = ((BitmapDrawable) mDrawable).getBitmap();
                try {
                    File f=new File(Rationcard.this.getExternalCacheDir(),"ThisIsImageTitle"+ " - " + (Calendar.getInstance().getTime())+".jpeg");
                    FileOutputStream fout=new FileOutputStream(f);
                    mBitmap.compress(Bitmap.CompressFormat.JPEG,80,fout);
                    fout.flush();
                    fout.close();
