...
import com.example.docsecure.FullScreenZoom;
...
public class CardspicGlobal extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cardspic_global);
        if (ActivityCompat.checkSelfPermission(CardspicGlobal.this, Manifest.permission.READ_EXTERNAL_STORAGE)== PackageManager.PERMISSION_DENIED || ActivityCompat.checkSelfPermission(CardspicGlobal.this, Manifest.permission.CAMERA)== PackageManager.PERMISSION_DENIED){
            ActivityCompat.requestPermissions(CardspicGlobal.this,new String[]{
        ...
        id=getIntent().getStringExtra("Creditcardnameid");
        ...
        sp=getSharedPreferences("Creditcardfront"+username+id,MODE_PRIVATE);
        if(sp!=null) {
        ...
        sp2=getSharedPreferences("Creditcardback"+username+id,MODE_PRIVATE);
        if(sp2!=null) {
        ...
        img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    Intent full = new Intent(CardspicGlobal.this, FullScreenZoom.class);
                    imagezoom=bitmap;
                    full.putExtra("zoomid","creditcardzoom");
                    startActivity(full);
                }
                catch (Exception e){
                    Toast.makeText(CardspicGlobal.this, ""+e, Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    File f=new File(CardspicGlobal.this.getExternalCacheDir(),"ThisIsImageTitleString"+ " - " + (Calendar.getInstance().getTime())+".jpeg");
        ...
        share1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Bitmap mBitmap = ((BitmapDrawable) mDrawable).getBitmap();
                try {
                    File f=new File(CardspicGlobal.this.getExternalCacheDir(),"ThisIsImageTitle"+ " - " + (Calendar.getInstance().getTime())+".jpeg");
                    FileOutputStream fout=new FileOutputStream(f);
                    mBitmap.compress(Bitmap.CompressFormat.JPEG,80,fout);
                    fout.flush();
                    fout.close();
