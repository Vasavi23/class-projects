...
public class Licence extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ActivityCompat.checkSelfPermission(Licence.this, Manifest.permission.READ_EXTERNAL_STORAGE)== PackageManager.PERMISSION_DENIED || ActivityCompat.checkSelfPermission(Licence.this, Manifest.permission.CAMERA)== PackageManager.PERMISSION_DENIED){
            ActivityCompat.requestPermissions(Licence.this,new String[]{
        ...
        username=getIntent().getStringExtra("Licenceid");
        ...
        front=findViewById(R.id.Licencefrontu1);
        back=findViewById(R.id.Licencebacku1);


        sp=getSharedPreferences("Licencefront"+username,MODE_PRIVATE);
        if(sp!=null) {
        ...
        sp2=getSharedPreferences("Licenceback"+username,MODE_PRIVATE);
        if(sp2!=null) {
        ...
        img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    Intent full = new Intent(Licence.this, FullScreenZoom.class);
                    imagezoom=bitmap;
                    full.putExtra("zoomid","licencezoom");
                    startActivity(full);
                }
                catch (Exception e){
                    Toast.makeText(Licence.this, ""+e, Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    File f=new File(Licence.this.getExternalCacheDir(),"Licencefront"+ " - " + (Calendar.getInstance().getTime())+".jpeg");
        ...
        share1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Bitmap mBitmap = ((BitmapDrawable) mDrawable).getBitmap();
                try {
                    File f=new File(Licence.this.getExternalCacheDir(),"Licenceback"+ " - " + (Calendar.getInstance().getTime())+".jpeg");
                    FileOutputStream fout=new FileOutputStream(f);
                    mBitmap.compress(Bitmap.CompressFormat.JPEG,80,fout);
                    fout.flush();
                    fout.close();
